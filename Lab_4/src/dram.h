...
{
    /*
    * Flag to denote whether the entry is valid
    */
    bool valid;

    /*
    * Row id to check if the entry is valid
    */
    uint64_t row_id;
...
typedef struct DRAM
{
    ...
    /*
    * Array of row buffer entries
    */
    std::vector<RowBuffer> row_buffer_array;

    /*
    * Number of index bits to use
    */
    unsigned int num_bank_bits;

    /*
    * Number of tag bits to use
    */
